...
def style_label(master, text, size=None, bold=None, family=None, width=None, height=None, bg=None, fg=None, style=None,
                styles=None):
    """ 启用样式的标签 """
...
def tkimg_resized(img, w_box, h_box, keep_ratio=True):
    ...
    if w_box is None or h_box is None:
        ...
        if keep_ratio:
            ...
            width = w_box
            height = h_box
        # img1 = PIL.Image.open(img.resize((width, height), pil.Image.ANTIALIAS))
