    ...
    with tf.Graph().as_default():
        with tf.Session() as sess:
            ...
            image_preprocessing_fn, image_unprocessing_fn = preprocessing_factory.get_preprocessing(
                FLAGS.loss_model,
                is_training=False)
            processed_images = reader.image(batch_size, FLAGS.image_size, FLAGS.image_size,
                                            'I:/coco/train2017/', image_preprocessing_fn, epochs=FLAGS.epoch)
            ...
            tf.summary.image('origin', tf.stack([
                image_unprocessing_fn(image) for image in tf.unstack(processed_images, axis=0, num=batch_size)
            ]))
            ...
            try:
                while not coord.should_stop():
                    ...
                    if step % 1000 == 0:
                        ...
                        # fname = 'D:/bysj/optimize/fast-neural-style-video/models/ink/generated/ink_%d.png' % (step)
                        # imsave(fname, processed_generated[step])
